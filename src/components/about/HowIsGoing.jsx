...
import { ReactComponent as Scribble} from "@assets/icons/scribbleHowIsGoing.svg";
  ...
  return (
    <section className="bg-white w-screen">
      ...
      <div className="flex justify-center py-10 md:px-40 ">
        ...
        <h1 className="text-align-left md:text-4xl font-satoshi font-bold sm:text-3xl ">How is Going...</h1>
      ...
      { datas && datas.map(({aboutImgTwo, id, aboutImgDescTwo}) => (
       ...
       <p1 className="lg:py-auto text-align-left font-satoshi md:text-xl text-wrap sm:text-xl">{aboutImgDescTwo}</p1>
       <img src={aboutImgTwo} className="mt-10 lg:mt-0 rounded-3xl"/>
        </div>
      ))}
      </div>
      </div>
